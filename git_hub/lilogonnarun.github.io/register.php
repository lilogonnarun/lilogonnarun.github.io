...
<head>
    ...
    <title>Register - CJ's coffee shop</title>
    <!-- Bootstrap core CSS -->
...
<h1 class="site-heading text-center text-white d-none d-lg-block">
    ...
    <span class="site-heading-lower">specialty coffee</span>
</h1>
...
<section class="page-section about-heading">
    <div class="container">
        <video src="audio/Pexels Videos 2675515.mp4" class="img-fluid rounded about-heading-img mb-3 mb-lg-0" autoplay
               controls></video>
                ...
                <div class="col-xl-9 col-lg-10 mx-auto">
                    <div class="bg-faded rounded p-5">
                        ...
                        <form method="post" action="register.php" class="needs-validation">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn" name="reg_user" class="form-control">Register</button>
                            </div>
                            <p>
